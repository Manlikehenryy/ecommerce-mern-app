...
import useGetAllCartItemDetails from '../../hooks/useGetAllCartItemDetails'
...
import { useAuthContext } from "../../context/AuthContext";
 ...
 const Cart = ({showCart,setShowCart}) => {
  ...
  useEffect(()=>{
    const price = cartItemDetails.reduce((accumulator, cartItem) => {
      return  (cartItem.noOfItem * cartItem.productId.price) + accumulator;
    }, 0); 
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                     ...
                     <CartItems cartItemDetails = {cartItemDetails} loading={loading}/>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div className="mt-6">
                        ...
                        >
		 					          ...
		 					          {loadingOrder ? <span className='loading loading-spinner'></span> : "Checkout"}
